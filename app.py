...
with st.sidebar:
  ...
  with tab3:
    ...
    st.button('View full article', on_click=open_page(newslist[0]), key="1")
    st.caption(newslist[3])
    st.button('View full article', on_click=open_page(newslist[2]), key="2")
    st.caption(newslist[5])
    st.button('View full article', on_click=open_page(newslist[4]), key="3")
    st.caption(newslist[7])
    st.button('View full article', on_click=open_page(newslist[6]), key="4")
    st.caption(newslist[9])
    st.button('View full article', on_click=open_page(newslist[8]), key="5")
    st.caption(newslist[11])
    st.button('View full article', on_click=open_page(newslist[10]), key="6")
    st.caption(newslist[13])
    st.button('View full article', on_click=open_page(newslist[12]), key="7")
    st.caption(newslist[15])
    st.button('View full article', on_click=open_page(newslist[14]), key="8")
    st.caption(newslist[17])
    st.button('View full article', on_click=open_page(newslist[16]), key="9")
